...
object DetectUserAgentsBenchmark {
  ...
  class BenchmarkState {
    val parser = {
      ...
      new BrowscapUserAgentParser(dataStore)
    }
  }
...
class DetectUserAgentsBenchmark {

  import DetectUserAgentsBenchmark._


  @Benchmark
  def detect(benchmarkState: BenchmarkState): Unit = {
    val time = System.currentTimeMillis()
    dataSet
      .map(
        benchmarkState.parser.parse)
  }
}
